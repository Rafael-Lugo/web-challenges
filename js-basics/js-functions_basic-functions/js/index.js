...
let name = "The Lord of the Javascript";
let author = "Mario";
let rating = 4.2;
let copiesNumber = 120;
...
// --v-- write your code here --v--
function logBookData(name, author, rating, copiesNumber) {
  console.log(
    "Title: " +
      name +
      ", Author:" +
...
logBookData(name, author, rating, copiesNumber);
